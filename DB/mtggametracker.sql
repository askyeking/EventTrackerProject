...
CREATE TABLE IF NOT EXISTS `game` (
  ...
  `game_losses` INT(11) NOT NULL,
  `game_draws` INT(11) NOT NULL DEFAULT '0',
  `deck` VARCHAR(45) NULL DEFAULT NULL,
  `opponent_deck` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 6
...
SET SQL_MODE = '';
DROP USER IF EXISTS planeswalker@localhost;
SET SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
CREATE USER 'planeswalker'@'localhost' IDENTIFIED BY 'planeswalker';

GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE * TO 'planeswalker'@'localhost';
